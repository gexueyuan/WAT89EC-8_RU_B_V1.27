...
typedef  struct __attribute__ ((packed)) _DATE_TIME
{
	unsigned char year;
	unsigned char month;
	unsigned char day;
...
typedef struct __attribute__ ((packed))  _USER_TITLE
{
	OWORD_VAL fieldname1;
	OWORD_VAL fieldname2;
	OWORD_VAL fieldname3;
	OWORD_VAL fieldname4;
	OWORD_VAL fieldname5;
	OWORD_VAL fieldname6;
	OWORD_VAL fieldname7;
	OWORD_VAL fieldname8;
	OWORD_VAL fieldname9;
	OWORD_VAL fieldname10;	
}USERTITLE;

typedef struct __attribute__ ((packed)) _UARTInitParameter
{
	unsigned int *comaddress;     //the address of the mode register
	unsigned int BaudRate;        //baudrate
	unsigned char check;          //verify mode
	unsigned char WordLength;     //the number of data bits
	unsigned char StopBitLength;  //the number of stop bits
}UARTInitParameter;
typedef struct __attribute__ ((packed)) _tagUARTFLAG
{
        unsigned URT1IN  :1;
        unsigned URT2IN  :1;
        unsigned URT3IN  :1;
