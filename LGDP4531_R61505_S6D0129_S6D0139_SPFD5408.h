...
#else
#define SetIndex(index)  RS_LAT_BIT=0;RD_LAT_BIT=1;PMPWaitBusy();PMDIN1=(unsigned char)index;WR_LAT_BIT=0;PMPWaitBusy();WR_LAT_BIT=1;
//#define SetIndex(index)  RS_LAT_BIT=0;PMPWaitBusy();PMDIN1=(unsigned char)index;WR_LAT_BIT=0;PMPWaitBusy();WR_LAT_BIT=1;
#endif
/*********************************************************************
...
#else
#define WriteData(byte1,byte0) RS_LAT_BIT=1;RD_LAT_BIT=1;PMDIN1=(unsigned char)byte1;WR_LAT_BIT=0;PMPWaitBusy();WR_LAT_BIT=1;PMDIN1=(unsigned char)byte0;WR_LAT_BIT=0;PMPWaitBusy();WR_LAT_BIT=1;
//#define WriteData(byte1,byte0) RS_LAT_BIT=1;PMDIN1=byte1;WR_LAT_BIT=0;PMPWaitBusy();WR_LAT_BIT=1;PMDIN1=byte0;WR_LAT_BIT=0;PMPWaitBusy();WR_LAT_BIT=1;
#endif

#ifdef USE_SSD1289
#define ReadData(readByte)	RS_LAT_BIT=1;RD_LAT_BIT=1;WR_LAT_BIT=1;PMPWaitBusy();RD_LAT_BIT=0;readByte=PMDIN1;PMPWaitBusy();
#endif
...
#else
	#define SetAddress(addr2, addr1, addr0)  \
	SetIndex(0x4e);WriteData(0,addr0);\
	SetIndex(0x4f);WriteData(addr2,addr1);\
	SetIndex(0x22);
#endif
/*********************************************************************
