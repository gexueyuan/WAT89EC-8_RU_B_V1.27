 ...
 *  Samsung S6D0129/S6D0139 LCD controller driver
 *****************************************************************************
 * FileName:        S6D0129_S6D0139.c
...
void ResetDevice(void){
   ...
   DelayMs(10);
	...
	WR_LAT_BIT=1;
	RD_TRIS_BIT=1;
	RD_LAT_BIT=1;	//add by Spring.Chen
...
*/
	...
	DelayMs(15);
	SetReg(0x0003, 0xAAAC);
	SetReg(0x000C, 0x0002);
	SetReg(0x000D, 0x000A);
	SetReg(0x000E, 0x2C00);
	SetReg(0x001E, 0x00aE);
	DelayMs(15);
	SetReg(0x0001, 0x2B3F);
	SetReg(0x0002, 0x0600);
	SetReg(0x0010, 0x0000);
	SetReg(0x0011, 0x60B0);
	DelayMs(20);
	SetReg(0x0005, 0x0000);
	SetReg(0x0006, 0x0000);
	SetReg(0x0016, 0xEF1C);
	SetReg(0x0017, 0x0003);
	SetReg(0x0007, 0x0233);
//	SetReg(0x0007, 0x0203);
	SetReg(0x000B, 0x5321);
	SetReg(0x000F, 0x0000);
	DelayMs(20);
	SetReg(0x0041, 0x0000);
	SetReg(0x0042, 0x0000);
	SetReg(0x0048, 0x0000);
	SetReg(0x0049, 0x013F);
	SetReg(0x0044, 0xEF00);
	SetReg(0x0045, 0x0000);
	SetReg(0x0046, 0x013F);
	SetReg(0x004A, 0x0000);
	SetReg(0x004B, 0x0000);
	DelayMs(20); 
...
//	SetReg(0x0023, 0x0000);
//	SetReg(0x0024, 0x0000);
	DelayMs(20);
	SetIndex(0x0022); 
