...
extern unsigned char _time_str[16]; // Sat 10:01:15
extern unsigned char _date_str[16]; // Sep 30, 2005
 ...
 * EOF
 *****************************************************************************/
#define ControlByteW	0xa2	// 控制字:写准备(器件地址000)
#define ControlByteR	0xa3	//控制字:读准备(器件地址000)
#define PCF8563Addr	0x02	// /*指定操作地址*/
extern void I2cInit();
extern void I2C_Stop(void);
extern void SetEEPROMRead(void);
extern void SetRtccAddress(WORD address);
